...
if __name__ == '__main__':
    ...
    games_files = ['lichess_db_standard_rated_2020-01.pgn', 'lichess_db_standard_rated_2020-02.pgn']
    ...
    with open(meta_file_path, 'w', newline='') as csv_file:
        ...
        for f in games_files:
            with open('../games/{0}'.format(f)) as games_file:
